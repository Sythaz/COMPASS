<form id="form-tolak" data-action="{{ route('verifikasi-pendaftaran.tolak', $pendaftaran->pendaftaran_id) }}">
    @csrf
    <div class="modal-header bg-primary rounded">
        <h5 class="modal-title text-white"></i>Tolak Verifikasi Pendaftaran Lomba</h5>
    ...
    <div class="modal-body">
        <div class="alert alert-danger">
            ...
            <strong class="alert-heading h4">Apakah anda yakin untuk menolak verifikasi data Pendaftaran lomba
                ini?</strong>
        </div>
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="{{ $pendaftaran->lomba->nama_lomba ?? '-' }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="form-group">
                    <label for="alasan_tolak" class="text-danger font-weight-bold">
                        <i class="fa fa-exclamation-circle"></i> Alasan Penolakan <span class="text-danger">*</span>
                    </label>
                    <textarea name="alasan_tolak" id="alasan_tolak" class="form-control"
                        placeholder="Contoh: Tidak memenuhi syarat ketentuan lomba." required></textarea>
    ...
    <div class="modal-footer">
        <button type="button" onclick="submitTolak()" class="btn btn-danger">Tolak</button>
...
<script>
    function submitTolak() {
        ...
        const alasanField = document.getElementById('alasan_tolak');
        const alasan = alasanField.value.trim();
        ...
        if (!alasan) {
            ...
            alasanField.classList.remove('is-invalid');
        }
