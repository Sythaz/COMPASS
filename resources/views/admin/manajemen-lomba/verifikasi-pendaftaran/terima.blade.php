<form id="form-terima" data-action="{{ route('verifikasi-pendaftaran.terima', $pendaftaran->pendaftaran_id) }}">
    @csrf
    <div class="modal-header bg-primary rounded">
        <h5 class="modal-title text-white"></i>Terima Verifikasi Pendaftaran Lomba</h5>
    ...
    <div class="modal-body">
        <div class="alert alert-success">
            ...
            <strong class="alert-heading h4">Apakah anda yakin untuk verifikasi data Pendaftaran lomba ini?</strong>
        </div>
        <!-- Informasi Lomba -->
        <div class="card mb-3">
    ...
    <div class="modal-footer">
        <button type="button" onclick="submitTerima()" class="btn btn-success">Ya, Terima</button>
...
<script>
    function submitTerima() {
        const form = document.getElementById('form-terima');
        ...
        fetch(actionUrl, {
            ...
            .then(res => {
                Swal.fire({
                    ...
                    $('#pendaftaranTable').DataTable().ajax.reload(); // ✅ Reload tabel
                });
            })
            .catch(err => {
