<div class="modal-header bg-primary rounded">
    <h5 class="modal-title text-white">
        <i class="fas fa-history mr-2"></i>Detail Histori Pengajuan Lomba
    </h5>
...
<div class="modal-body">
    ...
    <!-- Status Verifikasi & Informasi Tambahan -->
    <div class="card mb-3">
        <div class="card-header bg-light">
            <h6 class="mb-0">
                <i class="fas fa-check-circle mr-2"></i>Status Verifikasi & Informasi Tambahan
            </h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" value="{{ $lomba->status_verifikasi }}" disabled>
                            <div class="input-group-append">
                ...
                @if ($lomba->status_lomba === 'Nonaktif')
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-form-label font-weight-bold">Status Lomba</label>
                        <div class="input-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <textarea class="form-control" rows="3" disabled>{{ $lomba->alasan_tolak }}</textarea>
                            <div class="input-group-append">
                                <span class="input-group-text bg-danger text-white">
            ...
            <div class="status-info mt-3 p-3 bg-light rounded">
                <div class="row align-items-center">
                    <div class="col-6">
                        <strong>
                            <i class="fas fa-clipboard-check mr-2"></i>Status Keseluruhan:
                        </strong>
                    </div>
                    <div class="col-6 text-right">
                        @switch($lomba->status_verifikasi)
                            @case('Menunggu')
                                <span class="badge badge-warning badge-lg">
                                    <i class="fas fa-hourglass-half mr-1"></i>{{ $lomba->status_verifikasi }}
                                </span>
                                @break
                            @case('Ditolak')
                                <span class="badge badge-danger badge-lg">
                                    <i class="fas fa-times-circle mr-1"></i>{{ $lomba->status_verifikasi }}
                                </span>
                                @break
                            @default
                                <span class="badge badge-success badge-lg">
                                    <i class="fas fa-check-circle mr-1"></i>{{ $lomba->status_verifikasi }}
                                </span>
                        @endswitch
                        
                        @if ($lomba->status_lomba === 'Nonaktif')
                            <span class="badge badge-danger badge-lg ml-2">
                                <i class="fas fa-archive mr-1"></i>Terhapus
                            </span>
                        @endif
                    </div>
                </div>
...
<style>
    ...
    .registration-status, .status-info {
