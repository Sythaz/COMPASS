<form id="formTambahMahasiswa" method="POST" action="{{ url('admin/kelola-pengguna/mahasiswa/store') }}">
    ...
    <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nim_mahasiswa" class="col-form-label font-weight-bold">NIM 
                                <span class="text-danger">*</span>
                            </label>
                            <div class="custom-validation">
                                <div class="input-group">
                                    <input type="text" name="nim_mahasiswa" id="nim_mahasiswa" class="form-control" 
                                           placeholder="Masukkan NIM Mahasiswa" required value="{{ old('nim_mahasiswa') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nama_mahasiswa" class="col-form-label font-weight-bold">Nama Lengkap 
                                <span class="text-danger">*</span>
                            </label>
                            <div class="custom-validation">
                                <div class="input-group">
                                    <input type="text" name="nama_mahasiswa" id="nama_mahasiswa" class="form-control" 
                                           placeholder="Masukkan Nama Lengkap" required value="{{ old('nama_mahasiswa') }}">
                                    <div class="input-group-append">
                    ...
                    <div class="custom-validation">
                        <div class="input-group">
                            <select name="kelamin" id="kelamin" class="form-control" required>
                                ...
                                <option value="L" {{ old('kelamin', $mahasiswa->kelamin ?? '') == 'L' ? 'selected' : '' }}>
                                    Laki-laki
                                </option>
                                <option value="P" {{ old('kelamin', $mahasiswa->kelamin ?? '') == 'P' ? 'selected' : '' }}>
                                    Perempuan
                                </option>
                            </select>
                            <div class="input-group-append">
        ...
        <div class="card mb-3">
            <div class="card-header bg-light">
                <h6 class="mb-0"><i class="fas fa-university mr-2"></i>Informasi Akademik</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="prodi_id" class="col-form-label font-weight-bold">Program Studi 
                                <span class="text-danger">*</span>
                            </label>
                            <div class="custom-validation">
                                <div class="input-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="periode_id" class="col-form-label font-weight-bold">Periode 
                                <span class="text-danger">*</span>
                            </label>
                            <div class="custom-validation">
                                <div class="input-group">
        ...
        <!-- Informasi Minat Bakat -->
        <div class="card mb-3">
            <div class="card-header bg-light">
                <h6 class="mb-0"><i class="fas fa-star mr-2"></i>Minat & Bakat</h6>
            </div>
            <div class="card-body">
                <div class="form-group">
                    <label for="kategori_id" class="col-form-label font-weight-bold">Minat Bakat
                        <span class="text-danger">*</span>
                    </label>
                    <div class="custom-validation">
                ...
                <div class="alert alert-info mb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Pengguna ini akan didaftarkan sebagai <strong>Mahasiswa</strong> sistem.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-primary">
            <i class="fa-solid fa-floppy-disk mr-2"></i>Simpan Mahasiswa
        </button>
...
<style>
    ...
    /* Select2 wrapper dengan icon yang rapi */
    .select2-wrapper {
        position: relative;
    }
    ...
    /* Menyempurnakan tampilan Select2 untuk fokus */
...
<script>
    ...
    // Custom validation untuk NIM (format tertentu jika diperlukan)
    $.validator.addMethod("nimFormat", function(value, element) {
        if (!value) return false;
        return /^[0-9A-Za-z]{6,}$/.test(value); // Minimal 6 karakter alfanumerik
    }, "NIM harus berupa karakter alfanumerik minimal 6 digit");
    ...
    customFormValidation(
        ...
        },
        {
            nim_mahasiswa: { 
                ...
                nimFormat: "NIM harus berupa karakter alfanumerik minimal 6 digit"
            },
            nama_mahasiswa: { 
            ...
            'kategori_id[]': { 
                required: "Pilih Minimal 1 Minat Bakat" 
            },
            email: {
