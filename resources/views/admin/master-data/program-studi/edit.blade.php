    ...
    <div class="modal-body">
        ...
        <div class="card">
            <div class="card-header bg-light">
                <h6 class="mb-0"><i class="fas fa-university mr-2"></i>Informasi Program Studi</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="status_prodi" class="col-form-label font-weight-bold">
                                Status Program Studi <span class="text-danger">*</span>
                            </label>
                            <div class="custom-validation">
                                <div class="input-group">
                                    <select name="status_prodi" id="status_prodi" class="form-control" required>
                                        ...
                                        <option value="Nonaktif" {{ old('status_prodi', $prodi->status_prodi) == 'Nonaktif' ? 'selected' : '' }}>
                                            Nonaktif
                                        </option>
                                    </select>
                                    <div class="input-group-append">
                                        @php
                                            $currentStatus = old('status_prodi', $prodi->status_prodi);
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#status_prodi').on('change', function() {
