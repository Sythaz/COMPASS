<form id="form-delete" method="POST" action="{{ url('admin/master-data/program-studi/' . $prodi->prodi_id) . '/delete' }}">
    @csrf
    @method('PUT')

    <div class="modal-header bg-warning rounded">
        <h5 class="modal-title text-dark"><i class="fas fa-archive mr-2"></i>Nonaktifkan Program Studi</h5>
    ...
    <div class="modal-body">
        ...
        <div class="alert alert-warning border-0 shadow-sm mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="alert-heading mb-1">Konfirmasi Nonaktifkan Program Studi</h5>
        ...
        <div class="card mb-3">
            <div class="card-header bg-light">
                <h6 class="mb-0"><i class="fas fa-graduation-cap mr-2"></i>Detail Program Studi</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                ...
                @if(isset($prodi->kode_prodi))
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-form-label font-weight-bold">Kode Program Studi</label>
                            <div class="input-group">
                                <input type="text" class="form-control" value="{{ $prodi->kode_prodi }}" disabled>
                                <div class="input-group-append">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" value="{{ $prodi->status ?? 'Aktif' }}" disabled>
                                <div class="input-group-append">
            ...
            <div class="card-body text-center">
                <div class="info-section bg-info bg-opacity-10 rounded p-3">
                    ...
                    <p class="text-muted small mb-0">
                        Program Studi yang dinonaktifkan tidak akan muncul dalam pilihan pendaftaran baru, 
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-warning">
            <i class="fas fa-archive mr-2"></i>Ya, Nonaktifkan Program Studi
        </button>
            ...
            success: function(response) {
                if (response.success) {
                    Swal.fire({
                        ...
                        $('#tabel-program-studi').DataTable().ajax.reload(null, false);
                    });
                } else {
                    Swal.fire({
                        title: 'Error!',
