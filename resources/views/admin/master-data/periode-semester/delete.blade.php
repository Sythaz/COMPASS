<form id="form-delete" method="POST" action="{{ url('admin/master-data/periode-semester/' . $periode->periode_id) }}">
    ...
    <div class="modal-header bg-warning rounded">
        <h5 class="modal-title text-dark"><i class="fas fa-archive mr-2"></i>Nonaktifkan Periode Semester</h5>
    ...
    <div class="modal-body">
        ...
        <div class="alert alert-warning border-0 shadow-sm mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="alert-heading mb-1">Konfirmasi Nonaktifkan Periode Semester</h5>
        ...
        <div class="card mb-3">
            <div class="card-header bg-light">
                <h6 class="mb-0"><i class="fas fa-calendar-alt mr-2"></i>Detail Periode Semester</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="card-body text-center">
                <div class="info-section bg-info bg-opacity-10 rounded p-3">
                    ...
                    <p class="text-muted small mb-0">
                        Periode Semester yang dinonaktifkan tidak akan muncul dalam pilihan aktif, 
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-warning">
            <i class="fas fa-archive mr-2"></i>Ya, Nonaktifkan Periode Semester
        </button>
