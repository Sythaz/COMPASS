<form id="form-terima-verifikasi" method="POST"
    action="{{ url('admin/manajemen-prestasi/verifikasi-prestasi/verifikasi/' . $prestasi->prestasi_id) }}">
    @csrf
    @method('PUT')
    <div class="modal-header bg-primary rounded">
        <h5 class="modal-title text-white"></i>Terima Verifikasi Prestasi</h5>
