<form id="form-tolak-verifikasi" method="POST"
    action="{{ route('verifikasi-prestasi.tolakPrestasi', $prestasi->prestasi_id) }}">
    @csrf
    @method('PUT')
    ...
    <div class="modal-body">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                {{-- Menampilkan form alasan tolak jika status prestasi ditolak --}}
                <div class="mt-3">
                    <div class="mt-3">
                        <div class="card border-danger">
                            <div class="card-header bg-danger text-white d-flex align-items-center">
                                <i class="fas fa-exclamation-triangle mr-2"></i>
                                <strong>Alasan Penolakan Data Prestasi</strong>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="alasan_tolak" class="col-form-label font-weight-bold text-danger">
                                        Silakan jelaskan alasan penolakan prestasi ini!
                                    </label>
                                    <textarea name="alasan_tolak" id="alasan_tolak" class="form-control border-danger text-danger" rows="3"
                                        placeholder="Contoh: Dokumen pendukung tidak valid, data tidak sesuai, dll." required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        @foreach ($prestasi->mahasiswa as $index => $mhs)
                            <div class="anggota-item bg-light rounded p-3 mb-2">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control"
                                            value="{{ $mhs->nama_mahasiswa }}" disabled>
                                        <div class="input-group-append">
                                            @if (($mhs->pivot->peran ?? 'Anggota') === 'Ketua')
