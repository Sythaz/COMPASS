    ...
    <div class="row">
        <div class="col-lg-4 col-sm-6">
            <div class="card gradient-1">
                <div class="card-body">
                    <h3 class="card-title text-white">Performa Bimbingan</h3>
                    <div class="d-inline-block mt-auto">
                        <h1 class="text-white my-3">60%</h1>
                    </div>
                    <span class="float-right display-5 opacity-5"><i class="fas fa-trophy"></i></span>
