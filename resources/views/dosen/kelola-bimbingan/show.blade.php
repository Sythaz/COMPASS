        ...
        <tr>
            ...
            <td class="text-start">
                @if (
                    ...
                    <a href="{{ asset('storage/prestasi/img/' . $kelolaPrestasi->img_kegiatan) }}" data-lightbox="prestasi"
            ...
            <td class="text-start">
                @if (
                    ...
                    <a class="btn btn-primary"
                        href="{{ asset('storage/prestasi/bukti/' . $kelolaPrestasi->bukti_prestasi) }}" target="_blank">
