...
@section('title', 'Profile Dosen | COMPASS')

@section('page-title', 'Profile Dosen')

@section('page-description', 'Halaman untuk melihat dan mengelola profile dosen!')
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="profileTabsContent">
                                ...
                                <div class="profile-info">
                                    <div class="info-grid">
                                        <div class="info-item">
                                            ...
                                            <span class="info-value">{{ $dosen->nip_dosen ?? 'NIP Tidak Diketahui' }}</span>
                                        </div>
                                        <div class="info-item">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <span class="info-value">{{ $dosen->alamat ?? 'Alamat Tidak Diketahui' }}</span>
                                        </div>
                                        <div class="info-item">
                                            <span class="info-label">Email</span>
                                            <span class="info-value">{{ $dosen->email ?? 'Email Tidak Diketahui' }}</span>
                                        </div>
                                        <div class="info-item">
                        ...
                        <div class="tab-pane fade" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
                            <div class="row">
                                <div class="col-md-7">
                                    <form id="formEdit" action="{{ route('dosen.profile.update') }}" method="POST"
                                        ...
                                        <div class="form-group custom-validation">
                                            ...
                                            <input type="text" placeholder="Masukkan NIP Baru"
                                                class="form-control @error('nip_dosen') is-invalid @enderror" id="nip_dosen"
                                                name="nip_dosen"
                                                value="{{ old('nip_dosen', $dosen->nip_dosen ?? 'NIP Tidak Diketahui') }}"
                                                required readonly>
                                        </div>
                                        ...
                                        <div class="form-group custom-validation">
                                            ...
                                            <input type="text" placeholder="Masukkan Nama Lengkap Baru"
                                                ...
                                                value="{{ old('nama_dosen', auth()->user()->getName() ?? 'Anonim') }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group custom-validation">
                                            ...
                                            <textarea class="form-control @error('alamat') is-invalid @enderror" placeholder="Masukkan Alamat Baru"
                                                id="alamat" name="alamat" rows="3" required>{{ old('alamat', $dosen->alamat ?? 'Alamat Tidak Diketahui') }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group custom-validation">
                                            ...
                                            <input type="email" placeholder="Masukkan Email Baru"
                                                ...
                                                name="email"
                                                value="{{ old('email', $dosen->email ?? 'Email Tidak Diketahui') }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group custom-validation">
                                            ...
                                            <input type="text" placeholder="Masukkan No. HP Baru"
                                                ...
                                                name="no_hp"
                                                value="{{ old('no_hp', $dosen->no_hp ?? 'No. HP Tidak Diketahui') }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group custom-validation">
                                            ...
                                            <select class="form-control @error('kelamin') is-invalid @enderror"
                                                ...
                                                <option value="P"
                                                    {{ old('kelamin', $dosen->kelamin) == 'P' ? 'selected' : '' }}>
                                                    Perempuan</option>
                                                <option value="L"
                                                    {{ old('kelamin', $dosen->kelamin) == 'L' ? 'selected' : '' }}>
                                                    Laki-laki</option>
                                            </select>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="edit-preferensi" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <form id="formEditPreferensi" action="{{ route('dosen.profile.preferensi') }}"
                        ...
                        <div class="tab-pane fade" id="change-password" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <form action="{{ route('ubah-password-dosen') }}" method="POST" id="passwordForm">
                                        @csrf
    ...
    <script>
        ...
        customFormValidation(
            "#formEdit", {
                username: {
                    remote: {
                        url: "{{ route('dosen.profile.cek-username') }}",
                        type: "post",
                        data: {
                            _token: "{{ csrf_token() }}",
                            username: function() {
