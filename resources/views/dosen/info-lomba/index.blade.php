                    ...
                    <div class="card-body">
                        <div class="row align-items-center mb-3">
                            <div class="col-lg-8">
                                ...
                                <p class="text-muted mb-0">Temukan lomba yang sesuai dengan minat dan kemampuan mahasiswa</p>
                            </div>
                            <div class="col-lg-4 text-right">
                                <button class="btn btn-primary font-weight-bold"
                                    onclick="modalAction('{{ route('info-lomba.tambah-rekomendasi-ajax') }}')">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <button class="btn btn-secondary text-white btn-sm btn-block"
                                                onclick="modalAction('{{ route('info-lomba.show', $lomba->lomba_id) }}')">
                                                <i class="fa fa-eye"></i> Detail
                                            </button>
                                        </div>
                                        <div class="col-6">
                                            <button
                                                onclick="modalAction('{{ url('/dosen/info-lomba/rekomendasi-lomba/' . $lomba->lomba_id . '/rekomendasi_ajax') }}')"
